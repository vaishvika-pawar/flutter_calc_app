                        ...
                        IconButton(
                            onPressed: () {
                              calculatorBloc.add(BackSpace(
                                  currentaUserInput: calcTextController.text));
                            },
                            icon: Icon(
                    ...
                    Expanded(
                      ...
                      child: Wrap(
                        children: [
                          CalcButtons(
                              calcObj: CalcObj(
                                  buttonText: "C", onpressEvent: Clear()),
                              calculatorBloc: calculatorBloc),
                          CalcButtons(
                              calcObj: CalcObj(
                                  buttonText: "()", onpressEvent: Clear()),
                              calculatorBloc: calculatorBloc),
                          CalcButtons(
                              calcObj: CalcObj(
                                  buttonText: "%",
                                  onpressEvent: OperatorInput(
                                      opr: "%",
                                      currentaUserInput:
                                          calcTextController.text)),
                              calculatorBloc: calculatorBloc),
                          CalcButtons(
                              calcObj: CalcObj(
                                  buttonText: "/",
                          ...
                          CalcButtons(
                              ...
                              calcObj: CalcObj(
                                  buttonText: "=",
                                  onpressEvent: ShowFinalResult(currentaUserInput:
                                          calcTextController.text)),
                              calculatorBloc: calculatorBloc),
                        ],
                      ),
